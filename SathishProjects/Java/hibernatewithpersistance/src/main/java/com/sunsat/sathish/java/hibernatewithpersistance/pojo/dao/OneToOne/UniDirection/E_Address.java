...
/**
 CREATE TABLE `001_e_address_onetoone_fk` (
 ...
 PRIMARY KEY (`id`),
 KEY `e_address_to_e_employee__fk` (`e_employee_id`),
 CONSTRAINT `e_address_to_e_employee__fk` FOREIGN KEY (`e_employee_id`) REFERENCES `001_e_employee_onetoone_fk` (`id`) ON UPDATE CASCADE
