 ...
 */
public class UdpEventPublisherByLock extends  Thread {

    DatagramSocket socket = null;
    public UdpEventPublisherByLock(DatagramSocket socket) {
        this.socket = socket;
    }
    public static void main(String ... args) {
        ...
        try {
            ...
            UdpEventPublisherByLock pub1 = new UdpEventPublisherByLock(s1);
